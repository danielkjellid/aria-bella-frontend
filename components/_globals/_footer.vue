  ...
  <footer class="bg-brand-50">
    <div style="max-width: 1600px;" class="md:flex md:items-center md:justify-between lg:px-8 sm:px-8 px-5 py-12 mx-auto">
      <div class="md:order-2 flex justify-center space-x-6">
        ...
        <a href="https://www.instagram.com/bella_studio/" class="hover:text-brand-600 text-brand-500">
        ...
        <a href="https://www.facebook.com/Bellafliser" class="hover:text-brand-600 text-brand-500">
      ...
      <div class="md:mt-0 md:order-1 mt-8">
        <p class="text-brand-600 text-base leading-6 text-center">
          &copy; 2021 Bella Fliser og Design AS. Alle rettigheter reservert.
        </p>
      </div>
    </div>
  </footer>
